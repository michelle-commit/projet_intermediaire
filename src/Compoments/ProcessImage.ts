...
import ProcessImageBox from './BoundingBox';
import ProcessImageEyeglasses from './Eyeglasses';
import ProcessImageGender from './Gender';
import ProcessImageMouthopen from './Mouthopen';
import ProcessImageMustache from './Mustache';
import ProcessImageSmile from './Smile';
import ProcessImageSunglasses from './Sunglass';


 export default function ProcessImage(event:any) {
    ProcessImageBox();
    ProcessImageBeard();
    ProcessImageEyeglasses();
    ProcessImageSmile();
    ProcessImageSunglasses();
    ProcessImageGender();
    ProcessImageMustache();
    ProcessImageMouthopen();
    AnonLog();
